...
public class CoordinateConversion
{
  ...
  public double[] latLon2UTM_angle(double latitude, double longitude, double angle, double dist)
  {
    LatLon2UTM c = new LatLon2UTM();
    return c.convertLatLonToUTM_and_back(latitude, longitude, angle, dist);
  ...
  private class LatLon2UTM
  {
    ...
    public double[] convertLatLonToUTM_and_back(double latitude, double longitude, double angle, double dist)
    {
      validate(latitude, longitude);
      String UTM = "";
      ...
      double _easting = getEasting()+dist*Math.sin(Math.PI/180*angle);
      double _northing = getNorthing(latitude)+dist*Math.cos(Math.PI/180*angle);
